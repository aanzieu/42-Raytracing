...
/*   Updated: 2017/09/18 15:36:37 by aanzieu          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		sepia_effect2(t_color *color)
{
	int		tmp;
	t_color	tmpx;

	tmp = (((double)color->r * 0.393 + (double)color->g * 0.769 +
				(double)color->b) * 0.189) * 1.8;
	tmpx.r = tmp > 255 ? 255 : tmp;
	tmp = (((double)color->r * 0.349 + (double)color->g * 0.686 +
				(double)color->b) * 0.168) * 1.8;
	tmpx.g = tmp > 255 ? 255 : tmp;
	tmp = (((double)color->r * 0.272 + (double)color->g * 0.534 +
				(double)color->b) * 0.131) * 1.8;
