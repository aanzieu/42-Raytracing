		...
		int i)
{
	...
	ui_widget_value_infos(c, m, &w->hyperboloids[i].reflection_coef, "REFLECTION:");
	ui_widget_value_infos(c, m, &w->hyperboloids[i].refraction_coef, "REFRACTION:");
	ui_widget_value_infos(c, m, &w->hyperboloids[i].transparence_coef, "TRANSPARENCE:");
