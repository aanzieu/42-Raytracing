	...
	int i)
{
	...
	ui_widget_value_infos(c, m, &w->planes[i].reflection_coef,"REFLECTION:");
	ui_widget_value_infos(c, m, &w->planes[i].refraction_coef,"REFRACTION:");
	ui_widget_value_infos(c, m, &w->planes[i].transparence_coef,"TRANSPARENCE:");
