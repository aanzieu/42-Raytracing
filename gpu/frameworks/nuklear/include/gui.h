...
void	draw_objects_button_3(struct nk_context *ctx, struct media *media, t_world *w);
...
void	draw_light_type(struct nk_context *c, struct media *m, t_world *w, t_light *light);
